...
//ESP
static HUDUserDefaultsKey const HUDUserDefaultsKeyPlayerLine = @"line";
static HUDUserDefaultsKey const HUDUserDefaultsKeyPlayerBone= @"bone";
static HUDUserDefaultsKey const HUDUserDefaultsKeyPlayerInfo = @"info";
static HUDUserDefaultsKey const HUDUserDefaultsKeyPlayerHP = @"health";
