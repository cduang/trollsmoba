...
@implementation HUDRootViewController {
    ...
    ScreenshotInvisibleContainer *_ESPView;
...
- (void)reloadUserDefaults
{
    ...
    if (hideAtSnapshot) {
        ...
        [_ESPView setupContainerAsHideContentInScreenshots];
        
    } else {
        [_ESPView setupContainerAsDisplayContentInScreenshots];
...
- (void)viewDidLoad
{
    ...
    BOOL GZB = [直播 boolValue];
    
    if(GZB){
        [noScreenShotView addSubview:view];//过直播开关
        [noScreenShotView setUserInteractionEnabled:NO];//过直播开关
    }else{
...
//   _ESPView.hiddenContainer.translatesAutoresizingMaskIntoConstraints = YES;
//    [_ESPView addSubview:view];
//    [self.view addSubview:_ESPView.hiddenContainer];
